    ...
    <div className="max-w-2xl mx-auto space-y-6">
      ...
      {isSetupRequired && (
        ...
        >
          ...
          <div>
            <h3 className="font-heading font-bold text-amber-900 text-sm sm:text-base">
              Profile Setup Required
            </h3>
            <p className="text-xs sm:text-sm text-amber-700 mt-1 leading-relaxed">
              Please enter your <span className="font-bold">Full Name</span>, <span className="font-bold">City</span>, and <span className="font-bold">Country</span> below and click <span className="font-bold">&quot;Save Changes&quot;</span> to save them into the database. Other dashboard features are locked until your details are saved.
            </p>
          </div>
        </motion.div>
      )}
